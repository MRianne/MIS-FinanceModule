	...
	<body class="acm-body">
		<div class="center" style="float: left; width:20%;">
			...
			<div class="collection">
				...
				<a href="finance/pages/Overall_Report.php"  class="collection-item"><span class="acm-color">Finance</span></a>
		...
		<iframe name = "acm-menu" src="finance/pages/Overall_Report.php" frameborder="0" width="80%" height="100%"></iframe>
	</body>
</html>

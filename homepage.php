	...
	<body class="acm-body">
		<div class="center" style="float: left; width:20%;">
			...
			<div class="collection">
				...
				<a href="finance/pages/Overall Report.html" data-target="#portfolioModal1" class="collection-item"><span class="acm-color">Finance</span></a>
		...
		<iframe name = "acm-menu" src="finance/pages/Expense Reports.html" frameborder="0" width="80%" height="100%"></iframe>
	</body>
</html>
